...
6. 사용자 키워드 배치: 정확히 6회 배치 (절대 준수)
   - 제목: 1회 ("노보텔 사이공센터 [키워드 포함 문장]" 형태)
   - 서론(1번 문단): 1회 (정확히 1회만, 중복 금지)
   - 본론(2~15번 중): 3회 (10번, 13번, 15번 문단에 배치, 원숫자 ①②③ 표시, 다른 문단에는 절대 금지)
   - 결론(16번 문단): 1회 (정확히 1회만, 중복 금지)
   - 본론의 원숫자는 정확히 ①②③ 3개만 표시
   - **절대 중요: 각 섹션에서 키워드는 정확히 지정된 회수만 배치 (초과 금지)**
...
- 각 키워드 문장은 위의 좋은 예들처럼 다양한 문맥에서 자연스럽게 나와[결론(16번 문단) 키워드 배치 규칙 - 매우 중요]
- 사용자 키워드를 **정확히 1회만** 배치 (중복 절대 금지)
- 예: "이처럼 완벽한 호치민 출장을 만들어준 노보텔 사이공센터에 진심으로 감사드려요."
- 나쁜 예: "완벽한 호치민 출장" + "다음번 호치민 방문" (키워드 2회 - 중복)
- 결론에서 키워드는 단 한 번 만 나타나도록 주의
...
- 본론(2~15번): 각 100~150자
- 결론(16번): 200~250자
- 각 문단의 분량을 균형있게 배분하여 전체 1800자 달성절대 금지]
- 마크다운 형식 사용 금지
- 제목에 마침표(.) 금지
- 제목에 느낌표(!) 사용 금지
