...
[절대 준수 규칙]
1. 제목: 반드시 "호텔명 + 키워드" 형태로 작성 (예: "노보텔 사이공센터, ${userKeywords}") - 키워드 '${userKeywords}'는 절대 변경 금지, 사용자 입력 그대로 사용
...
[제목 작성 규칙]
- 반드시 "호텔명 + 키워드" 형태로 작성: "노보텔 사이공센터, ${userKeywords}"
- 예시 1: 사용자 입력이 "호치민 출장"이면 → "노보텔 사이공센터, 호치민 출장"
- 예시 2: 사용자 입력이 "기대 이상으로 빛났던 여정"이면 → "노보텔 사이공센터, 기대 이상으로 빛났던 여정"
...
- 매우 중요: 키워드는 제목 1회, 서론 1회, 본문 3회, 결론 1회 총 6회 배치
  * 제목: "노보텔 사이공센터, ${userKeywords}" 형태
  * 서론(1번): 1회
